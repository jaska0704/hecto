  ...
  return (
    <>
      <footer className=" bg-base-200 ">
         <div className="footer p-10 text-base-content container max-w-[1180px] mx-auto">
               <nav>
      ...
      <div className="bg-base-200">
          <footer className="footer px-10 py-4 border-t container max-w-[1180px] mx-auto text-base-content border-base-300">
